...
parser.add_argument('--base_architecture', default="deit_small_patch16_224", type=str)
...
from settings import num_train_epochs, num_warm_epochs, sum_cls, push_start, slots_train_epoch 
